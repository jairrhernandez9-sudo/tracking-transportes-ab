  ...
  try {
    const [usuarios] = await db.query(
      `SELECT id, nombre, email, rol, activo, fecha_creacion, cliente_id, sucursal_dir_id,
        ...
        ver_acciones_rapidas, auto_activar_cliente, documentar_activo, solo_guias_propias, auto_transito, puede_editar_historial, auto_transito_crear,
  ...
  try {
    ...
    await db.query(
      ...
      [
        ...
        req.body.solo_guias_propias       ? 1 : 0,
        req.body.auto_transito            ? 1 : 0,
        req.body.puede_editar_historial   ? 1 : 0,
        req.body.auto_transito_crear      ? 1 : 0,
